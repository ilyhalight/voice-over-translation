...
4. Установка собранного userscript:
   - Откройте менеджер юзерскриптов (например, Tampermonkey) и перейдите на вкладку **«Утилиты»**.
   - В разделе **«Установить из файла»** выберите файл `dist/vot.user.js` и подтвердите установку.
