...
/* harmony import */ var _config_config_cloudflare_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__("./src/config/config-cloudflare.js");
...
async function main() {
  ...
  function translateVideo(url, duration, requestLang, responseLang, callback) {
    ...
    if ( true && translationPanding) {
      _utils_debug_js__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z.log("translationPanding return");
      return;
    }
      ...
      if (dbData) {
        ...
        if (
          ...
          const checkbox = (0,_menu_js__WEBPACK_IMPORTED_MODULE_6__/* .createMenuCheckbox */ .H0)(
            "VOTAudioProxy",
            dbAudioProxy,
            _config_constants_js__WEBPACK_IMPORTED_MODULE_4__/* .translations */ .Iz[_menu_js__WEBPACK_IMPORTED_MODULE_6__/* .lang */ .KQ].VOTAudioProxy
          );

          checkbox.querySelector("#VOTAudioProxy").onclick = async (event) => {
            event.stopPropagation();
            const value = Number(event.target.checked);
            await (0,_indexedDB_js__WEBPACK_IMPORTED_MODULE_5__/* .updateDB */ .l6)({ audioProxy: value });
            dbAudioProxy = value;
            _utils_debug_js__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z.log("audioProxy value changed. New value: ", dbAudioProxy);
          };
      ...
      translateVideo(
        ...
        async (success, urlOrError) => {
          ...
          if (
            ...
            const proxiedAudioUrl = `https://${_config_config_cloudflare_js__WEBPACK_IMPORTED_MODULE_15__/* .workerHost */ .i}/video-translation/audio-proxy/${audioPath}`;
