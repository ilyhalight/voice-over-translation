...
- Переработан механизм авторизации с помощью Яндекса. Теперь, мы делаем только прямые запросы к API Яндекса, без использования дополнительного сервиса-прослойки
