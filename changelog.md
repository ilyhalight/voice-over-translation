...
<!-- Исправить дублирование кнопки на осн. Reddit -->

- Доработана логика поиска видео внутри ShadowDOM (#914)
- Добавлена поддержка получения URL в ответе GM_fetch
...
- [WIP. Доделать загрузку видео, сейчас гугл возвращает 403] Добавлена загрузка и отправка аудио файла видеоролика на сервера Яндекса для ускорения перевода (только для YouTube)
    <!-- Вынести кнопку из iframe в Google Drive как это сделано в 9animeTV т.к. ее перекрывает один из элементов выше iframe -->
