...
// Icons are built with `createElementNS`, never parsed from markup: pages such
// as YouTube enforce `require-trusted-types-for 'script'`, which rejects both
// `innerHTML` and `DOMParser.parseFromString`.

export const TRANSLATE_ICON_SVG = iconTemplate({
  tag: "svg",
  attrs: {
    width: "24",
    height: "24",
...
export const PIP_ICON_SVG = iconTemplate({
  tag: "svg",
  attrs: {
    height: "24",
...
export const MENU_ICON = iconTemplate({
  tag: "svg",
  attrs: {
    height: "24",
    viewBox: "0 -960 960 960",
...
export const DOWNLOAD_ICON = iconTemplate({
  tag: "svg",
  attrs: {
    width: "24",
    height: "100%",
...
export const SUBTITLES_ICON = iconTemplate({
  tag: "svg",
  attrs: {
    width: "24",
    height: "100%",
...
export const SETTINGS_ICON = iconTemplate({
  tag: "svg",
  attrs: {
    width: "24",
    height: "100%",
...
export const CHEVRON_ICON = iconTemplate({
  tag: "svg",
  attrs: {
    width: "24",
    height: "24",
...
export const ARROW_RIGHT_ICON = iconTemplate({
  tag: "svg",
  attrs: {
    height: "24",
    viewBox: "0 -960 960 960",
...
export const CLOSE_ICON = iconTemplate({
  tag: "svg",
  attrs: {
    width: "24",
    height: "100%",
...
export const WARNING_ICON = iconTemplate({
  tag: "svg",
  attrs: {
    width: "24",
    height: "24",
...
export const HELP_ICON = iconTemplate({
  tag: "svg",
  attrs: {
    width: "24",
    height: "24",
...
export const REFRESH_ICON = iconTemplate({
  tag: "svg",
  attrs: {
    width: "24",
    height: "24",
...
export const KEY_ICON = iconTemplate({
  tag: "svg",
  attrs: {
    width: "24",
    height: "24",
...
export const STANDARD_VOICE_ICON = iconTemplate({
  tag: "svg",
  attrs: {
    width: "20",
    height: "20",
    viewBox: "0 0 20 20",
    class: "vot-voice-icon vot-voice-icon--standard",
    "aria-hidden": "true",
  },
  children: [
    {
...
export const LIVE_VOICE_ICON = iconTemplate({
  tag: "svg",
  attrs: {
    width: "20",
    height: "20",
    viewBox: "0 0 20 20",
    class: "vot-voice-icon vot-voice-icon--live",
    "aria-hidden": "true",
  },
  children: [
    {
